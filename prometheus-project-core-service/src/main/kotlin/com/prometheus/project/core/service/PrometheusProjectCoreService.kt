...
@ComponentScan(basePackages = ["com.prometheus.project.*", "com.prometheus.project.core.service"])
class PrometheusProjectCoreService{

	/**
	 * The logger instance for this class
	 */
	private val logger = Logger.getLogger(PrometheusProjectCoreService::class.java.name)
